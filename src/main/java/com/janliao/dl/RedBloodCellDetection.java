package com.janliao.dl;

/** 
* @author 作者: JanLiao
* @date 时间: 2020年8月9日 上午12:00:55
*/
...
public class RedBloodCellDetection {
    ...
    public static void detection() throws Exception {
        ...
        String dataDir = "E:\\兼职\\程伟靖\\需求4\\所有图片混在一个文件中";
        ...
        if (new File(modelFilename).exists()) {
            ...
            System.out.println("model = " + model.summary(InputType.convolutional(height, width, nChannels)));
